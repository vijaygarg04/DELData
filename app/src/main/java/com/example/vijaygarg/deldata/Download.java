...
public class Download extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallApiButton=findViewById(R.id.btncallapi);
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        protected List<String> doInBackground(Void... params) {
            ...
            try {
                String fileId = "1QCJ80SV_ZG1O_tLOYujhSXnlt3Bha7xmTc3t-F2gA80";
                ...
                Drive mService = new com.google.api.services.drive.Drive.Builder(
                        ...
                        .setApplicationName("Drive API Android deldata")
                        .build();
//                retrievePermissions(mService,fileId);
//                insertPermission(mService,fileId);
//                retrievePermissions(mService,fileId);
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            Download.REQUEST_AUTHORIZATION);
                } else {
    ...
    private static Permission insertPermission(Drive service, String fileId) {
        ...
        newPermission.setId("11020812201478888784");
    ...
    private static List<Permission> retrievePermissions(Drive service,
        ...
        try {
            ...
            for(int i=0;i<permissions.getPermissions().size();i++){
                Log.i("Download",permissions.getPermissions().get(i).toString());
            }
